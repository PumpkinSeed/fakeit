...
mod tests {
    ...
    #[test]
    fn street_number() {
        exec_mes("address::street_number", || {
    ...
    #[test]
    fn street_prefix() {
        exec_mes("address::street_prefix", || {
    ...
    #[test]
    fn street_suffix() {
        exec_mes("address::street_suffix", || {
